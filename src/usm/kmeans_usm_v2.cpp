...
kmeans_cluster_t kmeans_usm_v2::cluster(const size_t max_iter, const double tol) {
  ...
  *converged = false;
  ...
  for (iter = 0; iter < max_iter; iter++) {
    ...
    {
      auto kernel = assign_points_to_clusters_kernel_v2{points_d, centroids_d, k, assoc_d};
    ...
    {
      auto kernel = partial_reduction_kernel_v2{
    ...
    {
      auto kernel = final_reduction_kernel_v2{
    ...
    {
      auto kernel = check_convergence_kernel_v2{k, tol, converged, centroids_d, new_centroids_d};
